...
values
    ('CS IV', (select id from api.users where name = 'aycii')),
...
values
    ('easy homework', 90, 0.15, false, (select id from api.courses where name = 'CS IV')),
    ('hard quiz', 50, 0.25, false, (select id from api.courses where name = 'CS IV')),
    ('future test', 95, 0.65, true, (select id from api.courses where name = 'CS IV')),
